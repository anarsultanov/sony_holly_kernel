...
#define CUST_EINT_EDP_INTN_NUM              13
#define CUST_EINT_EDP_INTN_DEBOUNCE_CN      0
#define CUST_EINT_EDP_INTN_TYPE							CUST_EINTF_TRIGGER_FALLING
#define CUST_EINT_EDP_INTN_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_DISABLE
